...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC066')
...
WebUI.setText(findTestObject('Object Repository/PolicyCenter_Login/input_PC_Login_TextBox_UserName'), 'account2059')
...
WebUI.click(findTestObject('Portal/Portal_Common_Tab_Billing'))
