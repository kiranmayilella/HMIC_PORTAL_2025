...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC028')
...
WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_MI_BureauID'), '86756722')

WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_IN_BureauID'), '8186756787')
