...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC002')
...
if (WebUI.verifyElementVisible(findTestObject('System Error/Portal_Quote_button_Tryagain'), FailureHandling.OPTIONAL) == 
true) {
