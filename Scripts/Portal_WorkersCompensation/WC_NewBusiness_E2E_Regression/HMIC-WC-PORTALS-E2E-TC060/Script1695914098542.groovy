...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC060')
...
not_run: WebUI.callTestCase(findTestCase('Portal_Pages/Portal_CommonScreens/Portal_SaveData'), [('State') : State, ('TCName') : TCName
        , ('LOB') : LOB], FailureHandling.OPTIONAL)
...
WebUI.verifyElementText(findTestObject('Portal/Portal_Accounts_UnauthorizedMessage'), 'Sorry, the account you are logged in with does not have the permissions required to access this page, or your login was unsuccessful.')
