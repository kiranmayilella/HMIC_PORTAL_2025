...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC025')
...
WebUI.click(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Line Coverages/Portal_LineCov_Blanket_Select_Illinois'))
