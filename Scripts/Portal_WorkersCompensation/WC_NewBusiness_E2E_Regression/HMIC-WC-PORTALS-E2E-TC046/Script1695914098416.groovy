...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC046')
...
WebUI.setText(findTestObject('Object Repository/Portal/Portal_AccInfo_TextBox_ZipCode'), '61705')
...
WebUI.setText(findTestObject('Object Repository/Portal/Portal_AccInfo_TextBox_Address'), '2225 W Market St')
...
WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Address'), '1618 W M 43 Hwy')
...
WebUI.click(findTestObject('Portal/Portal_Loc_WorkClassification_TypeList_0011'))
...
WebUI.click(findTestObject('Portal/Portal_Loc_btn_StandardizeAddress'))

WebUI.click(findTestObject('Portal/Portal_Loc_btn_AddLocation'))

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Address'), '3221 W 86th St')
...
WebUI.click(findTestObject('Portal/Portal_Loc_WorkClassification_TypeList_MultipleLoc_0005'))
...
WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Address'), '3701 E Calumet St')
...
WebUI.click(findTestObject('Portal/Portal_Loc_WorkClassification_TypeList_0006'))
...
WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Address'), '3105 Grand Ave')
...
WebUI.click(findTestObject('Portal/Portal_Loc_WorkClassification_TypeList_0005_IAState'))
...
WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Address'), '1575 Coshocton Ave')

WebUI.sendKeys(findTestObject('Portal/Portal_Loc_TextBox_Address'), Keys.chord(Keys.SPACE))

WebUI.click(findTestObject('Object Repository/Portal/Portal_AccInfo_TypeList_1stAddress'), FailureHandling.OPTIONAL)

WebUI.verifyElementText(findTestObject('Portal/Portal_Loc_InvalidLoc_ErrorMessage'), 'This state is not available to you. Please enter a new address or contact your underwriter at (800) 442-8277 for assistance.')

WebUI.click(findTestObject('Portal/Portal_Loc_Button_Cancel'))

WebUI.click(findTestObject('Portal/Portal_Loc_btn_AddLocation'))

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Address'), '13300 Cortez Blvd')
...
WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Address'), '2024 Genesee St')
...
WebUI.click(findTestObject('Portal/Portal_Loc_Button_Cancel'), FailureHandling.OPTIONAL)
...
WebUI.click(findTestObject('Portal/Portal_StateCov_ILState_Chkbox_ExpRating'))

WebUI.click(findTestObject('Portal/Portal_StateCov_ILState_input_ExpRating'))

WebUI.setText(findTestObject('Portal/Portal_StateCov_ILState_input_ExpRating'), '0.76')

WebUI.click(findTestObject('Portal/Portal_StateCov_Checkbox_ContractingClassAdj_ILState'))

WebUI.click(findTestObject('Portal/Portal_StateCov_TypeList_ContractingClassAdj_ILState'))

WebUI.click(findTestObject('Portal/Portal_StateCov_Select_Credit_5_ContractingClassAdj'))

WebUI.click(findTestObject('Portal/Portal_StateCov_Checkbox_BenefitsDeductibleEnd'))

WebUI.click(findTestObject('Portal/Portal_StateCov_MI_Chkbox_MeritRating'))

WebUI.click(findTestObject('Portal/Portal_StateCov_MI_TypeList_LostTimeClaims_MeritRating'))

WebUI.waitForPageLoad(5)

WebUI.click(findTestObject('Portal/Portal_StateCov_MI_Select_3_LostTimeClaims_MeritRating'))

WebUI.click(findTestObject('Portal/Portal_StateCov_Radiobtn_MI_FullTimeEmployees_Yes_MeritRating'))

WebUI.click(findTestObject('Portal/Portal_StateCov_MI_Radiobtn_WPSC_MeritOrExperience_Yes'))

WebUI.click(findTestObject('Portal/Portal_StateCov_INState_Chkbox_ExpRating'))

WebUI.click(findTestObject('Portal/Portal_StateCov_INState_input_ExpRating'))

WebUI.setText(findTestObject('Portal/Portal_StateCov_INState_input_ExpRating'), '1.22')

WebUI.click(findTestObject('Portal/Portal_StateCov_IAState_Chkbox_ExpRating'))

WebUI.click(findTestObject('Portal/Portal_StateCov_IAState_input_ExpRating'))

WebUI.setText(findTestObject('Portal/Portal_StateCov_IAState_input_ExpRating'), '1.2')

WebUI.click(findTestObject('Portal/Portal_StateCov_WIState_Chkbox_ExpRating'))

WebUI.click(findTestObject('Portal/Portal_StateCov_WIState_input_ExpRating'))

WebUI.setText(findTestObject('Portal/Portal_StateCov_WIState_input_ExpRating'), '0.9')
...
WebUI.click(findTestObject('Portal/Portal_Supplemental_CheckBox_AnyOtherInsurance'))
...
WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_IL_BureauID'), '897567898')

WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_MI_BureauID'), '91756722')

WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_IN_BureauID'), '718675678')

WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_IA_BureauID'), '827567898')

WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_WI_BureauID'), '917555667')
