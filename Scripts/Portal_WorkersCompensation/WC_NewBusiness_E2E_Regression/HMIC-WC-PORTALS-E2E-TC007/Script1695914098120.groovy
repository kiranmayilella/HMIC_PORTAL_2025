...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC007')
...
WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Address'), '8073 N State Route 50')
...
WebUI.click(findTestObject('Portal/Portal_Loc_WorkClassification_TypeList_0005'))

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_TotalPayroll'), '5000')

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_FullTimeEmployees'), '10')

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_PartTimeEmployees'), '10')
