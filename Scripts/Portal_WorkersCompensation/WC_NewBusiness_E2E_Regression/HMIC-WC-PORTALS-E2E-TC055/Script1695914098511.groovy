...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC055')
...
WebUI.setText(findTestObject('Object Repository/PolicyCenter_Login/input_PC_Login_TextBox_UserName'), 'ITUser01')
...
WebUI.verifyElementText(findTestObject('Portal/Portal_Quote_UnauthorizedMessage'), 'Sorry, the account you are logged in with does not have the permissions required to access this page, or your login was unsuccessful.')
