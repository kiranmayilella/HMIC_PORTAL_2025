...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC063')
...
WebUI.navigateToUrl('https://agencyportal.qa1.hastingsmutual.com')
...
WebUI.setText(findTestObject('Object Repository/PolicyCenter_Login/input_PC_Login_TextBox_UserName'), 'AgentVer1188')
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Portal/Portal_Quote_Header_NewBusinessDashboard'), 30)
