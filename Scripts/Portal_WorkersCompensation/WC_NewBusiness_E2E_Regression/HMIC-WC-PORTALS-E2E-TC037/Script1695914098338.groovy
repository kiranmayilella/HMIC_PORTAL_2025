...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC037')
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_CommonScreens/Portal_ExistingAccountSearch'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Portal/Portal_StateCov_input_ExpRating'), '1.76')
