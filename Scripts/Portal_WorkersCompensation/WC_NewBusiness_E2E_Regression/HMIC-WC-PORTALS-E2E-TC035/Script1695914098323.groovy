...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC035')

WebUI.callTestCase(findTestCase('Portal_Pages/Portal_CommonScreens/Portal_CreateAccount'), [:], FailureHandling.STOP_ON_FAILURE)
