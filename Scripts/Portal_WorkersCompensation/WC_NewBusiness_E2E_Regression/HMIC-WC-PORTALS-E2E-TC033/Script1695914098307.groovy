...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC033')
...
WebUI.setText(findTestObject('Object Repository/Portal/Portal_AccInfo_TextBox_ZipCode'), '54915')
...
WebUI.setText(findTestObject('Object Repository/Portal/Portal_AccInfo_TextBox_Address'), '3701 E Calumet St')
...
WebUI.setText(findTestObject('Portal/Portal_StateCov_WIState_input_ExpRating'), '3.12')
...
WebUI.click(findTestObject('Portal/Portal_AccAndIns_TypeList_ContactRole'))

WebUI.click(findTestObject('Portal/Portal_AccAndIns_Select_Accounting_ContactRole'))
...
WebUI.click(findTestObject('Portal/Portal_AccAndIns_btn_AddContact'))

WebUI.click(findTestObject('Portal/Portal_AccAndIns_TypeList_ContactRole'))

WebUI.click(findTestObject('Portal/Portal_AccAndIns_Select_Inspection_ContactRole'))
...
WebUI.setText(findTestObject('Portal/Portal_AccInfo_TextBox_FirstName'), 'Sam')

WebUI.setText(findTestObject('Portal/Portal_AccInfo_TextBox_LastName'), 'Joseph')

WebUI.setText(findTestObject('Portal/Portal_FirstCall_TextBox_EmailAddress'), 'ssomasundaram@hastingsmutual.com')

WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_WI_BureauID'), '912388776')

WebUI.click(findTestObject('Portal/Portal_AdditionalInfo_Checkbox_LossHistory'))

WebUI.click(findTestObject('Portal/Portal_AdditionalInfo_input_LossHistory_DateOfLoss'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_LossHistory_DateOfLoss'), '01/01/2020')

WebUI.click(findTestObject('Portal/Portal_AdditionalInfo_input_LossHistory_Description'))

WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_LossHistory_Description'), 'Traffic violation')

WebUI.click(findTestObject('Portal/Portal_AdditionalInfo_Button_LossHistory_Save'))

WebUI.click(findTestObject('Portal/Portal_AdditionalInfo_btn_AddLoss_LossHistory'))

WebUI.click(findTestObject('Portal/Portal_AdditionalInfo_input_LossHistory_DateOfLoss'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_LossHistory_DateOfLoss'), '10/10/2021')

WebUI.click(findTestObject('Portal/Portal_AdditionalInfo_input_LossHistory_Description'))

WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_LossHistory_Description'), 'DAMAGE TO VEHICLE')
...
WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_LossHistory_DateOfLoss'), '9/1/2018')
...
WebUI.click(findTestObject('Portal/Portal_AdditionalInfo_Container_PriorCarrierInfo'), FailureHandling.OPTIONAL)

WebUI.click(findTestObject('Portal/Portal_AdditionalInfo_button_Save_PriorCarrierInfo'))

WebUI.click(findTestObject('Portal/Portal_AdditionalInfo_btn_AddPriorCarrier_PriorCarrierInfo'))

WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_Carrier_PriorCarrierInfo'), 'GEICO INSURANCE COMPANY')

WebUI.click(findTestObject('Portal/Portal_AdditionalInfo_input_EffectiveDate_PriorCarrierInfo'), FailureHandling.STOP_ON_FAILURE)

WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_EffectiveDate_PriorCarrierInfo'), '10/10/2019')

WebUI.click(findTestObject('Portal/Portal_AdditionalInfo_input_ExpirationDate_PriorCarrierInfo'))

WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_ExpirationDate_PriorCarrierInfo'), '10/10/2020')
