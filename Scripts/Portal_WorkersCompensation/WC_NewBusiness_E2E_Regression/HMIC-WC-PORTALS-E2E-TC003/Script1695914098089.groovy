...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC003')
...
WebUI.setText(findTestObject('Object Repository/Portal/Portal_AccInfo_TextBox_ZipCode'), '50010')
...
WebUI.setText(findTestObject('Object Repository/Portal/Portal_AccInfo_TextBox_Address'), '3105 Grand Ave Ames')
...
not_run: WebUI.mouseOver(findTestObject('Portal/Portal_Supplemental_Checkbox_Aircraft'))

not_run: WebUI.click(findTestObject('Portal/Portal_Supplemental_Checkbox_Aircraft'))

not_run: WebUI.click(findTestObject('Portal/Portal_Supplemental_CheckBox_Above15feet'))

not_run: WebUI.mouseOver(findTestObject('Object Repository/Portal/Portal_Supplemental_CheckBox_IhaveReviewed'))
...
if (WebUI.verifyElementVisible(findTestObject('Quote System Error/Portal_Common_Button_Quote System Error_Button_Try again'), 
    FailureHandling.OPTIONAL) == true) {
    WebUI.click(findTestObject('System Error/Portal_Quote_button_Tryagain'))
}

not_run: WebUI.delay(150)
...
WebUI.setText(findTestObject('Portal/Portal_FirstCall_TextBox_EmailAddress'), 'test@hastingsmutual.com')

WebUI.click(findTestObject('Portal/Portal_AdditionalInfo_input_IA_BureauID'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_CertHolder_Address'), '3105 Grand Ave Ames')
...
WebUI.click(findTestObject('Portal/Portal_Review_Button_Submit to Underwriting'))

WebUI.click(findTestObject('Portal/Portal_Review_Submittounderwriting_Button_Ok'))
...
if (WebUI.waitForElementVisible(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_Button_ReleaseLock'),100)) {
...
WebUI.waitForElementVisible(findTestObject('Object Repository/Portal/Check_Quote_Result'), 300)
...
not_run: testresult = WebUI.getText(findTestObject('Portal/Portal_Quote_Table_QuoteNum', [('SubmissionNumber') : GlobalVariable.SubmissionNumber]))

not_run: System.out.println('value of testing ' + testresult)
...
not_run: WebUI.verifyElementText(findTestObject('Portal/Portal_SubSuccess_Text_The applicaton has been submitted'), 'This application has been issued. Please contact your underwriter with questions.')
