...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC069')
...
WebUI.click(findTestObject('PORTAL_HMIC/PORTAL_POLICY DETAILS/Page_Policy Details/Portal_PolicyDetails_EntityType_Dropdown1'))
...
WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_LossHistory_Description'), 'Test')
