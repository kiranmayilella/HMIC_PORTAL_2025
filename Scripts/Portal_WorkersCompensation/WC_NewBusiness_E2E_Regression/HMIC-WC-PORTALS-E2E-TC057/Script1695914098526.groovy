...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC057')
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_CommonScreens/Portal_Cancellation'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Portal/Portal_CancelPolicy_TypeList_Reason'))

WebUI.click(findTestObject('Portal/Portal_CancelPolicy_dropdown_Select_Reason_MidTerm'))

WebUI.click(findTestObject('Portal/Portal_CancelPolicy_TypeList_Description'))

WebUI.click(findTestObject('Portal/Portal_CancelPolicy_dropdown_Select_PriceTooHigh_Description'))

WebUI.click(findTestObject('Portal/Portal_CancelPolicy_btn_SubmitRequest'))

WebUI.verifyElementText(findTestObject('Portal/Portal_CancelRequest_Success_Label_CancellationSubmitted'), 'Your cancellation request has been submitted.')
...
WebUI.callTestCase(findTestCase('PolicyCenter_Pages/PC_Transactions/PC_PolicySummary_CurrentCancellationActivity'), [('AssignmentSelectFromList') : ''], 
    FailureHandling.STOP_ON_FAILURE)
