...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC018')
...
WebUI.click(findTestObject('PORTAL_PAYMENT/Page_HMIC Agency Portal - Workers Compensation - Payment/Portal_Payments_Auto_PaymentMethod_Downpayments_Add New Payment Method_Button'))
