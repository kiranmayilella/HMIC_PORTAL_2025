...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC006')
...
//def CurrentDate = WebUI.getText(findTestObject('Object Repository/Portal/Page_HMIC Agency Portal - Workers Compensation - Policy Details/Portal_PolicyDetails_Effective Date'))
//WebUI.verifyMatch(CurrentDate, GlobalVariable.currentDateAndTime, false, FailureHandling.CONTINUE_ON_FAILURE)
//WebUI.click(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Policy Details/Portal_Policydetails_Effectivedate_dropdown_calender'))
//WebUI.click(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Policy Details/Portal_Policydetails_Effectivedate_month_dropdown'))
//WebUI.click(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Policy Details/Portal_Policydetails_Effectivedate_November'))
//WebUI.click(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Policy Details/Portal_Policydetails_Effectivedate_Nov30'))
Date d = new Date()
...
c.add(Calendar.DAY_OF_MONTH, Integer.parseInt('31'))

Date currentDatePlus = c.getTime()

EffectiveDate = format.format(currentDatePlus)

WebUI.sendKeys(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Policy Details/Portal_PolicyDetails_Effective Date'), 
    Keys.chord(Keys.CONTROL, 'A', Keys.BACK_SPACE))

WebUI.setText(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Policy Details/Portal_PolicyDetails_Effective Date'), 
    EffectiveDate)

WebUI.sendKeys(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Policy Details/Portal_PolicyDetails_Effective Date'), 
    Keys.chord(Keys.ENTER))

WebUI.verifyElementText(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Policy Details/Portal_Policydetails_Effectivedate_WarningPolicy Effective Date is more than 30 days in advance'), 
    'Warning: Policy Effective Date is more than 30 days in advance. Rates are subject to change.')
...
WebUI.mouseOver(findTestObject('Portal/Portal_Payment_DirectBill_PaymentPlan_Radio_FullPay'))
