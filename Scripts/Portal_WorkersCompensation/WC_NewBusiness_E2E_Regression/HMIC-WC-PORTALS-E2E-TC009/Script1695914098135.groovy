...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC009')
...
WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_MI_BureauID'), '917567898')
...
WebUI.click(findTestObject('Portal/Portal_Payment_btn_SubmitPayment_PlzConfirmPopUp_Authorize'))
