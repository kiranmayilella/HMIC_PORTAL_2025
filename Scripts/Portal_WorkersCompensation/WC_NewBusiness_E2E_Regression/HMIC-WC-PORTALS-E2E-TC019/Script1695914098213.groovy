...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC019')
...
not_run: WebUI.click(findTestObject('Portal/Portal_StateCov_MI_Chkbox_ExpRating'))

not_run: WebUI.click(findTestObject('Portal/Portal_StateCov_MI_input_ExpRating'))

not_run: WebUI.setText(findTestObject('Portal/Portal_StateCov_MI_input_ExpRating'), '6')
...
WebUI.click(findTestObject('PORTAL_PAYMENT/Page_HMIC Agency Portal - Workers Compensation - Payment/Portal_Payments_PaymentMethod_Agency Account'))

WebUI.click(findTestObject('PORTAL_PAYMENT/Page_HMIC Agency Portal - Workers Compensation - Payment/Portal_Payments_PaymentPlans_ChooseAgencyAccount_DropDown'))

WebUI.click(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Payment/Portal_Payments_PaymentMethod_InsuredAcc_Select_0002059_Jim Simpson'))

WebUI.click(findTestObject('PORTAL_PAYMENT/Page_HMIC Agency Portal - Workers Compensation - Payment/Portal_Payments_PaymentPlans_AgencyPayCardSelection'))
