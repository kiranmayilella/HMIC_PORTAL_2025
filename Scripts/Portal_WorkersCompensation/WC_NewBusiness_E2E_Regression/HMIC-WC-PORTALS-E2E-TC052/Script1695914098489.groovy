...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC052')
...
SubmissionNumber = subNum.replace('Quote No. ', '')

WebUI.setText(findTestObject('Object Repository/Portal/Portal_Quote_TextBox_SearchFor'), SubmissionNumber)
...
WebUI.click(findTestObject('Portal/Portal_Quote_Table_QuoteNum', [('SubmissionNumber') : SubmissionNumber]))
...
WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_WI_BureauID'), '918786543')
