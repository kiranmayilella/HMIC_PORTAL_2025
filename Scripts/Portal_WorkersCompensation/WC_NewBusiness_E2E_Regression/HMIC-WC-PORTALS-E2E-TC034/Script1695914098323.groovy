...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC034')
...
WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_TotalPayroll_006'), '3000')

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_FullTimeEmployees_006'), '10')

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_PartTimeEmployees_006'), '10')

WebUI.click(findTestObject('Portal/Portal_Loc_Button_AddClassification'))

WebUI.click(findTestObject('Object Repository/Portal/Portal_Loc_TextBox_WorkClassification'))

WebUI.click(findTestObject('Portal/Portal_Loc_WorkClassification_TypeList_0008'))

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_TotalPayroll_008'), '2000')

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_FullTimeEmployees_008'), '10')

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_PartTimeEmployees_008'), '10')
...
WebUI.click(findTestObject('Portal/Portal_Payment_AgencyBill_PaymentPlan_Radio_FullPay'))
