...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC061')
...
not_run: WebUI.click(findTestObject('Portal/Portal_Payment_TypeList_BillingMethod'))

not_run: WebUI.click(findTestObject('Portal/Portal_Payment_Select_BillingMethod_Automatic'))
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_CommonScreens/Portal_Login'), [('Portal_Username') : 'rand2059', ('Portal_Password') : 'Hmic1234'], 
    FailureHandling.STOP_ON_FAILURE)

not_run: WebUI.mouseOver(findTestObject('Portal/Page_Agent Dashboard/Portal_Common_Tab_Accounts'))

not_run: WebUI.click(findTestObject('Portal/Page_Agent Dashboard/Portal_Common_Tab_Accounts'))

WebUI.setText(findTestObject('Portal/Page_HMIC Agency Portal - Account Search/Portal_Account_Textbox_Search for'), GlobalVariable.PolicyNumber)

WebUI.click(findTestObject('Portal/Page_HMIC Agency Portal - Account Search/Portal_Account_Button_Search'))

WebUI.click(findTestObject('Portal/Page_HMIC Agency Portal - Account Search/Portal_Account_Table_Policyno'))

WebUI.verifyElementNotPresent(findTestObject('Portal/Portal_Account _Policy Summary_Button_ Manage Policy/Portal_Account _Policy Summary_Button_ Manage Policy'), 
    20)
