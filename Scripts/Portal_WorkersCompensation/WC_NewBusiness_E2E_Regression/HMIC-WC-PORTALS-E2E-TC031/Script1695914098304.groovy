...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC031')
...
WebUI.setText(findTestObject('Object Repository/Portal/Portal_AccInfo_TextBox_Address'), '534 S Duff Ave')
...
WebUI.setText(findTestObject('Portal/Portal_StateCov_IAState_input_ExpRating'), '2.22')
