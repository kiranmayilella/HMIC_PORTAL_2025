...
WebUI.comment('HMIC-WC-PORTALS-E2E-TC022')
...
WebUI.setText(findTestObject('Object Repository/Portal/Portal_AccInfo_TextBox_Address'), 'Wisconsin 32, Kenosha, WI, USA')
...
WebUI.click(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Line Coverages/Portal_LineCov_Otherstates_Dropdown'))

WebUI.click(findTestObject('PORTAL_LINECOVERAGE4/Page_HMIC Agency Portal - Workers Compensation - Line Coverages/Portal_LineCoverage_StateSelection_All other non-monopolistic states'))

WebUI.click(findTestObject('PORTAL_LINECOVERAGE4/Page_HMIC Agency Portal - Workers Compensation - Line Coverages/Portal_LineCoverage_WI_CheckBox'))

WebUI.setText(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Line Coverages/Portal_LineCov_WI Waiver_input_Company Name'), 
    'HMIC')

WebUI.setText(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Line Coverages/Portal_LineCov_WI Waiver_input_Address_termValue'), 
    'WI')

WebUI.setText(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Line Coverages/Portal_LineCov_WI Waiver_input_No. of Contracts_termValue'), 
    '10')

WebUI.click(findTestObject('Portal/Page_HMIC Agency Portal - Workers Compensation - Line Coverages/Portal_LineCov_WI Waiver_Button_Save'))
...
not_run: WebUI.mouseOver(findTestObject('Portal/Portal_Payment_PaymentPlan_Radio_FullPay'))
...
WebUI.setText(findTestObject('Portal/Portal_Payment_TextBox_AgentContactEmail'), 'klella@gmail.com')
