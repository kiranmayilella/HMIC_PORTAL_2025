...
WebUI.setText(findTestObject('Object Repository/Portal/Portal_AccInfo_TextBox_Address'), '10850 Lincoln Trail')
...
WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_IL_BureauID'), '913244321')
