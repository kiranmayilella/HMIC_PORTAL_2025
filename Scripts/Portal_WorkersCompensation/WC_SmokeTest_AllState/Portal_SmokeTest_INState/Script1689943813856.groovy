...
not_run: WebUI.click(findTestObject('Portal/Portal_NewAccountCreated_Button_Continue'), FailureHandling.OPTIONAL)
...
WebUI.setText(findTestObject('Portal/Portal_StateCov_input_ExpRating'), '10')
...
WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_IN_BureauID'), '914543212')
...
not_run: WebUI.click(findTestObject('PolicyCenter/PolicyCenterObjects/PC_UWActivity_Button_Release'), FailureHandling.OPTIONAL)
...
WebUI.waitForElementHasAttribute(findTestObject('Portal/Portal_Common_Label_Header'), 'Step 9: Payment', 10, FailureHandling.OPTIONAL)

WebUI.verifyElementText(findTestObject('Portal/Portal_Common_Label_Header'), 'Step 9: Payment', FailureHandling.OPTIONAL)
