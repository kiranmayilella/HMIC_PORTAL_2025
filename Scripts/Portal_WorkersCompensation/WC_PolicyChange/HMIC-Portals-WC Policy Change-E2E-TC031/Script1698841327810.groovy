...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC031')
...
WebUI.click(findTestObject('Portal/Portal_StateCov_MI_Radiobtn_WPSC_DrugScreeningProg_Yes'))

WebUI.click(findTestObject('Portal/Portal_StateCov_MI_Radiobtn_WPSC_ActiveParticipation_Yes'))
