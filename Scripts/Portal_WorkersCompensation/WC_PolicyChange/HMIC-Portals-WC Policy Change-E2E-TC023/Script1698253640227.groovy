...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC023')
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Tab_Quote/Portal_Quote_AddNamedInsured'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Tab_Quote/Portal_Quote_AddDBA'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Tab_Quote/Portal_Quote_LineCoverages_AddWaiverOfSub_Iowa'), [:], FailureHandling.STOP_ON_FAILURE)
