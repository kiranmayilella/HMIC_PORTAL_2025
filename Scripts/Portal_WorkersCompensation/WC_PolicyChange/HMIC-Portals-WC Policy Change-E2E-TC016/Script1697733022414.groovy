...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC016')
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Transactions/Portal_PolicyChange_AddNonSpecificLocation_Indiana'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Portal/Portal_PolicyChange_Loc_TypeList_AddNewState'))

WebUI.click(findTestObject('Portal/Portal_PolicyChange_Loc_Select_AddNewState_Yes'))
