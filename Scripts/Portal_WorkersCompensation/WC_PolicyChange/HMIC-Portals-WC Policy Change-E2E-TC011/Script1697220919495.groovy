...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC011')
...
WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_WI_BureauID'), '913245432')
...
WebUI.click(findTestObject('Portal/Portal_PolicyChange_LocationPage_PrimaryLocIcon'))

WebUI.click(findTestObject('Portal/Portal_Loc_btn_LOC1_DeleteIcon'))
...
String errorMessage = WebUI.getText(findTestObject('Portal/Portal_PolicyChange_JSON_SystemError_DelLoc'))

String expectedErrorMessage = 'Cannot safely delete Location 1 – it is being used by a least one schedule of items attached to a Condition or Exclusion'
...
Assert.assertTrue(flag, 'Message has been displayed')
