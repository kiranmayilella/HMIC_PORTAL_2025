...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC043')
...
WebUI.click(findTestObject('Portal/Portal_Loc_WorkClassification_TypeList_0005_WI_Farm'))

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Payroll_005_Farm_WI State'), '5000')

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_FullTime_005_Farm_WI State'), '10')

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_PartTime_005_Farm_WI State'), '10')
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Tab_Quote/Portal_Quote_LineCoverages_OptionalCov_AddWIWaiver'), [:], 
...
WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_WI_BureauID'), '912332112')
