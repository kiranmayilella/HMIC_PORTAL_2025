...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC005')
...
WebUI.click(findTestObject('Portal/Portal_LineCov_Blanket_Select_Wisconsin'))
...
WebUI.setText(findTestObject('Portal/Portal_AdditionalInfo_input_WI_BureauID'), '913228786')
