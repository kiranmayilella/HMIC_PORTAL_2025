...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC038')
...
WebUI.click(findTestObject('Portal/Portal_PolicyChange_PolicyDetails_StepperMenu'))

WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Transactions/Portal_PolicyChange_AddSupportingPolicy_PolcyDetailsPage'), 
    [:], FailureHandling.STOP_ON_FAILURE)
