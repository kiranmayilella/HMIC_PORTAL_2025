...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC048')
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Transactions/Portal_PolicyChange_AddCertHolder'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.waitForPageLoad(20)

WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Transactions/Portal_PolicyChange_AddLossHistory'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Loc_AddLocation/Portal_AddLoc_IAState'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Loc_AddLocation/Portal_AddLoc_INState'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Portal/Portal_StateCov_label_SubHeader_IN'), 0)

WebUI.verifyElementPresent(findTestObject('Portal/Portal_StateCov_label_SubHeader_IA'), 0)

WebUI.verifyElementPresent(findTestObject('Portal/Portal_StateCov_label_SubHeader_MI'), 0)

WebUI.click(findTestObject('Portal/Portal_PolicyChange_Button_ReviewChanges'))

WebUI.waitForPageLoad(20)

WebUI.verifyElementPresent(findTestObject('Portal/Portal_PolicyChange_btn_Review_RemoveDraftChanges'), 0)

WebUI.verifyElementPresent(findTestObject('Portal/Portal_PolicyChange_btn_Review_Cancel'), 0)

WebUI.verifyElementPresent(findTestObject('Portal/Portal_PolicyChange_btn_Review_SubmitChanges'), 0)

WebUI.verifyElementPresent(findTestObject('Portal/Portal_PolicyChange_btn_Review_Previous'), 0)

WebUI.click(findTestObject('Portal/Portal_PolicyChange_btn_Review_SubmitChanges'))

WebUI.verifyElementText(findTestObject('Portal/Portal_PolicyChange_PCNotification_label_textValidation'), 'Your policy change request has been submitted to underwriting.  Please contact your underwriter at (800) 442-8277 with any questions.')
