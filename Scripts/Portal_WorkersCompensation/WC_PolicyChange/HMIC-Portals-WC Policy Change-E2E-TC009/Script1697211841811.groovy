...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC009')
...
WebUI.verifyElementAttributeValue(findTestObject('Portal/Portal_PolicyChange_StartPage_btn_ReviewOrEditPolicy'), 'class', 
    'dynamicButton__button jut__Button__button jut__Button__primary jut__Button__large jut__Button__disabled', 10)
