...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC044')
...
WebUI.click(findTestObject('Portal/Portal_Loc_WorkClassification_TypeList_0005_WI'))
...
WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Address'), '4331 8th St S')
...
WebUI.click(findTestObject('Portal/Portal_Loc_WorkClassification-TypeList_0005_WI_Shrub'))
...
WebUI.click(findTestObject('Portal/Portal_StateCov_TypeList_ContractingClassAdj_WIState'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Portal/Portal-StateCov_Select_Credit_20_ContractingClassAdj'), FailureHandling.STOP_ON_FAILURE)
