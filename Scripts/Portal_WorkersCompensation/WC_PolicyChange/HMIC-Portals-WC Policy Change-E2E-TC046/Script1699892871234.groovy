...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC046')
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Tab_Quote/Portal_Quote_LineCoverages_AddExclusion_000305'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Tab_Quote/Portal_Quote_LineCoverages_AddExclusion_000304'), [:], FailureHandling.STOP_ON_FAILURE)
