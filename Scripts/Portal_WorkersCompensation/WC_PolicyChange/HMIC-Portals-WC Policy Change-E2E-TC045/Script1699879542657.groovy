...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC045')
...
WebUI.click(findTestObject('Portal/Portal_Loc_WorkClassification_TypeList_0005_WI_Christmas'))
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Tab_Quote/Portal_Quote_AddNotes'), [:], FailureHandling.STOP_ON_FAILURE)
