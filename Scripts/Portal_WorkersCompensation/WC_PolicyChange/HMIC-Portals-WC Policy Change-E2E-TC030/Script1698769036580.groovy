...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC029')
...
WebUI.click(findTestObject('Portal/Portal_Loc_WorkClassification_TypeList_0005_MI'))
...
WebUI.click(findTestObject('Portal/Portal_StateCov_MI_TypeList_LostTimeClaims_MeritRating'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Portal/Portal_StateCov_MI_Select_3_LostTimeClaims_MeritRating'), FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Portal/Portal_StateCov_MeritRating_Radiobtn_FullTimeEmp_NO'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.click(findTestObject('Portal/Portal_PolicyChange_Loc_btn_Classification2_Deleteicon'))

WebUI.click(findTestObject('Portal/Portal_Loc_Button_Save'))

WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Loc_AddLocation/Portal_AddLoc_MIState'), [:], FailureHandling.STOP_ON_FAILURE)

WebUI.click(findTestObject('Portal/Portal_Common_Button_NextStateCov'))

WebUI.click(findTestObject('Portal/Portal_StateCov_MI_Radiobtn_WPSC_Past5Years_Yes'))
...
WebUI.verifyElementPresent(findTestObject('Portal/Portal_PolicyChange_label_ReviewPolchanges_UWDocReq'), 0)

WebUI.verifyElementPresent(findTestObject('Portal/Portal_PolicyChange_hyperlink_ReviewPolChanges_UWDocReq'), 0)

WebUI.click(findTestObject('Portal/Portal_PolicyChange_StateCoverages_StepperMenu'))

WebUI.click(findTestObject('Portal/Portal_StateCov_MI_Radiobtn_WPSC_Past5Years_No'))

WebUI.click(findTestObject('Portal/Portal_StateCov_MI_Radiobtn_WPSC_MeritOrExperience_No'))

WebUI.click(findTestObject('Portal/Portal_StateCov_MI_Radiobtn_WPSC_LightDutyProgram_No'))

WebUI.click(findTestObject('Portal/Portal_PolicyChange_Button_ReviewChanges'))

WebUI.waitForPageLoad(10)

WebUI.verifyEqual(findTestObject('Portal/Portal_Review_PolicyChange_text_NewPremium'), totalPremium_NBS)

WebUI.verifyElementNotPresent(findTestObject('Portal/Portal_PolicyChange_label_ReviewPolchanges_UWDocReq'), 0)

WebUI.verifyElementNotPresent(findTestObject('Portal/Portal_PolicyChange_hyperlink_ReviewPolChanges_UWDocReq'), 0)

WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Transactions/Portal_PolicyChange_RemoveDraftChanges'), [:], FailureHandling.STOP_ON_FAILURE)
