...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC033')
...
WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Address'), '28700 FRANKLIN RIVER DR')
...
WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Address'), '9201 RATHBONE ST')
...
WebUI.verifyElementPresent(findTestObject('Portal/Portal_Common_label_UnderwriterDetails'), 0)
