...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC065')
...
WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Address'), '4224 N Prospect Dr')
...
WebUI.click(findTestObject('Portal/Portal_Loc_WorkClassification_TypeList_0008_IN_Gardening'))
...
WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Address'), '7219 Walton St')
