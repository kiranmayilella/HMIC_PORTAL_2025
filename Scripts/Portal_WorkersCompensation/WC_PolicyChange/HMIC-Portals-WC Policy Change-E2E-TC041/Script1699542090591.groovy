...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC041')
...
WebUI.click(findTestObject('Portal/Portal_Loc_icon_Delete_PrimaryLocation'))
...
WebUI.verifyElementNotPresent(findTestObject('Portal/Portal_Common_Button_NextStateCov'), 0)

WebUI.verifyElementPresent(findTestObject('Portal/Portal_Common_Button_NextLineCov'), 0)

WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Tab_Quote/Portal_Quote_LineCoverages_AddWaiverOfSub_Wisconsin'), [:], 
    FailureHandling.STOP_ON_FAILURE)
