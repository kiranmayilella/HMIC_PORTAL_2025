...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC015')
...
WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Payroll_005_Tree_IN state'), '5000')

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_FullTime_005_Tree_IN State'), '10')

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_PartTime_005_Tree_IN State'), '10')
...
WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Address'), '225 W Chicago Ave')
