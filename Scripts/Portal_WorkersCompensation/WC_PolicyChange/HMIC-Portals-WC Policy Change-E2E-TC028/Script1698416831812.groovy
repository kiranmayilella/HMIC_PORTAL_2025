...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC028')
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Transactions/Portal_PolicyChange_AddNonSpecificLocation_Illinois'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Transactions/Portal_PolicyChange_AddNonSpecificLocation_Iowa'), [:], 
    FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Transactions/Portal_PolicyChange_AddNonSpecificLocation_Michigan'), 
    [:], FailureHandling.STOP_ON_FAILURE)

WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Transactions/Portal_PolicyChange_AddNonSpecificLocation_Wisconsin'), 
    [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Portal/Portal_StateCov_label_SubHeader_WI'), 0)
...
WebUI.click(findTestObject('Portal/Portal_StateCov_Select_Credit_35_ContactingClassAdj'))

WebUI.click(findTestObject('Portal/Portal_StateCov_Checkbox_ContractingClassAdj_WIState'))

WebUI.click(findTestObject('Portal/Portal_StateCov_TypeList_ContractingClassAdj_WIState'))

WebUI.click(findTestObject('Portal/Portal_StateCov_Select_Credit_35_ContactingClassAdj'))

WebUI.click(findTestObject('Portal/Portal_Common_Button_NextLineCov'))
