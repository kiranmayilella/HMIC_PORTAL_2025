...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC006')
...
WebUI.verifyElementAttributeValue(findTestObject('Portal/Portal_PolicyChange_StateCoverages_LeftNavigationPane_Disabled'), 
    'class', 'Step_step__tpIHD Step_disabled__3PS-3', 10)
