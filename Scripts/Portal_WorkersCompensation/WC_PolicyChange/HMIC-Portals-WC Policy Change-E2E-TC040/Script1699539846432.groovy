...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC040')
...
WebUI.setText(findTestObject('Portal/Portal_PolicyChange_textbox_AddNote_NotesIcon'), 'Entered for testing purpose')
