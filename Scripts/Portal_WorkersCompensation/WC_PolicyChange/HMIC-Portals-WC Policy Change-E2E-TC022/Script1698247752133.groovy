...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC022')
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_Loc_AddLocation/Portal_AddLoc_ILState'), [:], FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementPresent(findTestObject('Portal/Portal_StateCov_label_SubHeader_IL'), 0)
