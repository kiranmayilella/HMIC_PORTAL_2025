...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC050')
...
WebUI.click(findTestObject('Portal/Portal_Loc_WorkClassification_TypeList_0005__Reforestration_IL'))

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_Payroll_005_Reforestation_WI State'), '5000')

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_FullTime_005_Reforestation_WI State'), '10')

WebUI.setText(findTestObject('Portal/Portal_Loc_TextBox_PartTime_005_Reforestation_IL State'), '10')
