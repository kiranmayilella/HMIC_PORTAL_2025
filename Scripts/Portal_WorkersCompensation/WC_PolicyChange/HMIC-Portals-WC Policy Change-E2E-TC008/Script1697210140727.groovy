...
WebUI.comment('HMIC-Portals-WC Policy Change-E2E-TC008')
...
WebUI.verifyElementText(findTestObject('Portal/Portal_PolicyChange_Review_label_StopQuoting'), 'Are you sure you want to stop Quoting and leave?')
