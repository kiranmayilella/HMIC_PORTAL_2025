...
WebUI.click(findTestObject('Portal_ULP/Portal_PolicyInfo_Select_County_IN_Marion'))
...
WebUI.click(findTestObject('Portal_ULP/Portal_PolicyInfo_TypeList_VIPDiscount'))
