...
WebUI.mouseOver(findTestObject('Portal_ULP/Portal_PolicyInfo_Select_VIPDiscount_Quantum'))
...
WebUI.click(findTestObject('Portal_ULP/Portal_Exposures_Watercraft_Select_Type_OutBoard'))
...
WebUI.click(findTestObject('Portal_ULP/Portal_CompleteApplication_Chckbox_PriorCarrierInfo'))

WebUI.click(findTestObject('Portal_ULP/Portal_CompleteApplication_input_Carrier_PriorCarrierInfo'))

WebUI.setText(findTestObject('Portal_ULP/Portal_CompleteApplication_input_Carrier_PriorCarrierInfo'), 'HANOVER')

WebUI.click(findTestObject('Portal_ULP/Portal_CompleteApplication_input_EffectiveDate_PriorCarrierInfo'))

WebUI.setText(findTestObject('Portal_ULP/Portal_CompleteApplication_input_EffectiveDate_PriorCarrierInfo'), '01/01/2020')

WebUI.click(findTestObject('Portal_ULP/Portal_CompleteApplication_input_ExpirationDate_PriorCarrierInfo'))

WebUI.setText(findTestObject('Portal_ULP/Portal_CompleteApplication_input_ExpirationDate_PriorCarrierInfo'), '01/01/2021')

WebUI.click(findTestObject('Portal_ULP/Portal_CompleteApplication_button_Save_PriorCarrierInfo'))

WebUI.comment('Enter Loss History')
...
WebUI.setText(findTestObject('Portal_ULP/Portal_CompleteApplication_input_Description_LossHistory'), 'MET WITH AN ACCIDENT')
...
WebUI.comment('Change At Renewal')
