...
TestData exceldata = TestDataFactory.findTestData('IMC/New_Submission/new_submission')

String productName = exceldata.getValue(2, 2)
...
//Date d = new Date()
TestData exceldata_date = TestDataFactory.findTestData('IMC/Ploicy_Info/policy_info')

String d = exceldata_date.getValue(7, 2)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_DEV mode - 10.1.1.1463 Guidewire Polic_b28feb/select_noneIndividualJoint ventureLimited p_c25258'), 
    findTestData('IMC/Policy_Info/policy_info').getValue(12, 2), true)
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_DEV mode - 10.1.1.1463 Guidewire Polic_b28feb/select_noneFarmCommercial'), 
    findTestData('IMC/Policy_Info/policy_info').getValue(10, 2), true)

WebUI.click(findTestObject('Object Repository/Page_DEV mode - 10.1.1.1463 Guidewire Polic_b28feb/div_NeNext'))

WebUI.selectOptionByValue(findTestObject('IMC Objects/PolicyCenter_IMC_Risk_Type'), findTestData('IMC/CommericialInlandMarine/CommercialInlandMarine').getValue(
        1, 2), true)
