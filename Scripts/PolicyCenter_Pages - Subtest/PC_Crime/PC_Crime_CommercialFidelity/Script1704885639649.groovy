...
WebUI.selectOptionByLabel(findTestObject('PolicyCenter/PolicyCenterObjects/PC_CPP_Crime_CommercialFidelity_EmployeeTheftNameOrPositionSchedule_Dropdown_ScheduleType_'), 
    'Name Schedule', false)
