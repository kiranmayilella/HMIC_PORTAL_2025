...
if (TitleName.contains('Issues')) {
    ...
    WebUI.verifyTextNotPresent(UWIssueName, false)
} else {
    ...
    WebUI.click(findTestObject('PolicyCenter/PolicyCenterObjects/PC_RiskAnalysis_Tab_UWIssues'), FailureHandling.OPTIONAL)
...
WebUI.comment(('UW Issue - ' + UWIssueName) + ' is not triggered in Risk Analysis screen')
