...
WebUI.setText(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_TextBox_Address1'), NewLocation_Address1)
...
WebUI.setText(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_TextBox_City'), NewLocation_City)

WebUI.sendKeys(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_TextBox_City'), Keys.chord(Keys.TAB))

WebUI.waitForPageLoad(40)

WebUI.click(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_Button_Standardize'))
