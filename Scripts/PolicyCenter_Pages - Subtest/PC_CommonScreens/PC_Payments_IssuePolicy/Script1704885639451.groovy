...
WebUI.click(findTestObject('Object Repository/PolicyCenter/PolicyCenterObjects/PC_Payments_RadioButton_DBFullPay'))

WebUI.waitForPageLoad(30)

WebUI.waitForElementPresent(findTestObject('Object Repository/PolicyCenter/PolicyCenterObjects/PC_Payments_Button_SubmissionOptions'), 
    30)

WebUI.click(findTestObject('Object Repository/PolicyCenter/PolicyCenterObjects/PC_Payments_Button_SubmissionOptions'))

WebUI.waitForElementPresent(findTestObject('Object Repository/PolicyCenter/PolicyCenterObjects/PC_Payments_TypeList_IssuePolicy'), 
    30)

WebUI.click(findTestObject('Object Repository/PolicyCenter/PolicyCenterObjects/PC_Payments_TypeList_IssuePolicy'))

WebUI.acceptAlert(FailureHandling.OPTIONAL)

WebUI.takeFullPageScreenshot()

WebUI.waitForElementPresent(findTestObject('PolicyCenter/PolicyCenterObjects/PC_SubmissionBound_Link_ViewYourPolicy'), 30, 
...
if (!(TitleName.equals('Submission Bound') || TitleName.contains('Issues'))) {
...
if (Errormessage.equals('Premium is Below $500 Please re quote the transaction.')) {
    ...
    WebUI.waitForElementPresent(findTestObject('PolicyCenter/PolicyCenterObjects/PC_SubmissionBound_Link_ViewYourPolicy'), 
