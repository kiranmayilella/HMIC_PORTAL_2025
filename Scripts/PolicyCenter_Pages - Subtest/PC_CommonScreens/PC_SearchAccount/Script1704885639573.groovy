...
WebUI.setText(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Account_TextBox_AccountNumber'), AccountNumber)

WebUI.click(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Account_AccNum_Button_SearchIcon'))
