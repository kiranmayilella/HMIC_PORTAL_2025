...
PC_Common_Tab_ExclusionsConditions_SelectedOrNot = WebUI.getAttribute(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_Tab_ExclusionsAndConditions'), 
    'aria-selected')
