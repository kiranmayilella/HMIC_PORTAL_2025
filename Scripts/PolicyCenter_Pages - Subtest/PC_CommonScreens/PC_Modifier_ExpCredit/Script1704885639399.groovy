...
WebUI.selectOptionByLabel(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Modifiers_Category_Dropdown_CreditDebit_Employees-SelectionTrainingSupervisionExperience'),
	'0', false)

WebUI.selectOptionByLabel(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Modifiers_Category_Dropdown_CreditDebit_MedicalFacilities'),
	'0', false)

WebUI.selectOptionByLabel(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Modifiers_Category_Dropdown_CreditDebit_SafetyProgram'),
	'0', false)
