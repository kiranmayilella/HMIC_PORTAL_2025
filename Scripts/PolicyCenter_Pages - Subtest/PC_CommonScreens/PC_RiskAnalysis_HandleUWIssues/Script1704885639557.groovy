...
WebUI.waitForElementPresent(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_Label_Title'), 45)
...
if (TitleName.contains('Risk Analysis')) {
    ...
    if (eleSpecialApprove.equals(true)) {
        ...
        print(specialApproveButton.size())
    ...
    if (TransactionName.contains('Submission')) {
        ...
        WebUI.waitForElementPresent(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Payments_TypeList_IssuePolicy'), 
            10)
...
if (TitleName.contains('Issues')) {
    ...
    if (eleSpecialApprove.equals(true)) {
        ...
        for (int i = 0; i < specialApproveSize; i++) {
            WebUI.waitForElementPresent(findTestObject('Object Repository/PolicyCenter/PolicyCenterObjects/PC_RiskAnalysis_Button_SpecialApprove'), 
                45)
