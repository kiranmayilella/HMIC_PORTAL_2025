...
WebUI.verifyElementText(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_Label_Title'), 'Rewrite Full Term Bound')
...
WebUI.comment('Rewrite transaction issued successfully ' + PolicyNumber)
