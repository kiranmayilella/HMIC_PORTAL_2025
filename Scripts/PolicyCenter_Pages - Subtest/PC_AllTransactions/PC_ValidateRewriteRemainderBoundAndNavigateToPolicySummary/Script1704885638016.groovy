...
WebUI.verifyElementText(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_Label_Title'), 'Rewrite Remainder of Term Bound')
...
PolicyNumber = WebUI.getText(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_Link_PolicyNumber'))

WebUI.comment('Rewrite Remainder transaction issued successfully ' + PolicyNumber)
