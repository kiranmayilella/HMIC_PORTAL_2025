...
WebUI.sendKeys(findTestObject('PolicyCenter/PolicyCenterObjects/PC_StartPolicyChange_TextBox_EffectiveDate'), Keys.chord(
        Keys.TAB))
...
WebUI.sendKeys(findTestObject('PolicyCenter/PolicyCenterObjects/PC_StartPolicyChange_TextBox_Description'), Keys.chord(Keys.TAB))
