...
WebUI.click(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_LeftPanel_Forms'))
...
WebUI.verifyElementPresent(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Payment_Title_Payment'), 60)
