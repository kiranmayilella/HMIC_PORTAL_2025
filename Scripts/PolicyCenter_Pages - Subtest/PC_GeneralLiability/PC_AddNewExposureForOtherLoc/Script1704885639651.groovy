...
WebUI.verifyElementText(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_Label_Title'), 'Exposure Information')
...
WebUI.selectOptionByIndex(findTestObject('Object Repository/PolicyCenter/PolicyCenterObjects/PC_Exposures_TypeList_Location1'), 
    Exposures_LocationIndex, FailureHandling.STOP_ON_FAILURE)
