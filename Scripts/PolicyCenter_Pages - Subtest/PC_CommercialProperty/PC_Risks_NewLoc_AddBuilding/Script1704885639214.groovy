...
WebUI.click(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Risks_Link_LocationNumber', [('LocationNumber') : LocationNumber]))

WebUI.click(findTestObject('Object Repository/PolicyCenter/PolicyCenterObjects/PC_Risks_Button_AddBuilding'))

WebUI.verifyElementPresent(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_Label_TitleName', [('TitleName') : 'New Building']), 
    60)
...
if (LineSelection_RiskType.equals('Select Metalists I Program')) {
...
WebUI.verifyElementPresent(findTestObject('Object Repository/PolicyCenter/PolicyCenterObjects/PC_NewBuilding_TextBox_YearOfConstruction'), 
    60)
...
if (!(Building_IncludeInBlanketIDOtherthanEQ.equals(''))) {
    ...
    WebUI.selectOptionByLabel(findTestObject('PolicyCenter/PolicyCenterObjects/PC_NewBuilding_Blanket_DropDown_BlanketIDNumberOtherthanEQ'), 
        Building_BlanketIDNumber, false)
}
...
WebUI.verifyElementPresent(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_Label_TitleName', [('TitleName') : 'Risks']), 
    60)
