...
if (MiscellaneousFloaterCoverage.equals('IM 7502')) {
    WebUI.scrollToElement(findTestObject('PolicyCenter/PolicyCenterObjects/PC_IMC_MiscellaneousFloater_IM7502_Button_Add'), 
        10)

    WebUI.waitForPageLoad(10)

    WebUI.click(findTestObject('PolicyCenter/PolicyCenterObjects/PC_IMC_MiscellaneousFloater_IM7502_Button_Add'))
