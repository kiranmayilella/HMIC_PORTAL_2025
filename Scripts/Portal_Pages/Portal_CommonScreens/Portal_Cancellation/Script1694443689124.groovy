...
WebUI.comment('Processing Cancellation through Portal')
...
WebUI.callTestCase(findTestCase('Portal_Pages/Portal_CommonScreens/Portal_Policy_SearchPolicy'), [('PolicyNumber') : GlobalVariable.PolicyNumber], 
