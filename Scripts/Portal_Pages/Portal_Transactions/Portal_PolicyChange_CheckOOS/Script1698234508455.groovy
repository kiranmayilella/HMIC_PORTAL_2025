...
String actualOosMsg = WebUI.getText(findTestObject('Portal/Portal_PolicyChange_label_TextValidation_OOS'))

String expectedOosMsg = "This policy may have an Out of Sequence or Preemptive transaction associated with the submitted change. Please reach out to your Underwriter to resolve this issue."

boolean flag = false

if (actualOosMsg.equals(expectedOosMsg)) {
	
	flag = true

	WebUI.comment('Policy has OOS')
}

Assert.assertTrue(flag, 'Policy has OOS')
