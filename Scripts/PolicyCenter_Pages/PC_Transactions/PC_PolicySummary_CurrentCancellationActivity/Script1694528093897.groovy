...
WebUI.verifyElementText(findTestObject('PolicyCenter/PolicyCenterObjects/PC_ActivityDetail_Label_Subject'), 'Review and Approve Cancellation')
...
WebUI.selectOptionByLabel(findTestObject('PolicyCenter/PolicyCenterObjects/PC_AssignActivities_Dropdown_AssignmentSelectFromList'), 
    AssignmentSelectFromList, false, FailureHandling.OPTIONAL)
