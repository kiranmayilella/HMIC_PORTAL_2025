...
WebUI.click(findTestObject('PolicyCenter/PolicyCenterObjects/PC_PolicySummary_ActivityLink_ReviewandapprovePolicyChange'))

WebUI.waitForPageLoad(30)

String PolicyChange_TransactionNumber = WebUI.getText(findTestObject('PolicyCenter/PolicyCenterObjects/PC_Common_Label_TransactionNumber'))

WebUI.acceptAlert(FailureHandling.OPTIONAL)

'Activity subject is displayed as "Review and approve policy change"'
WebUI.verifyElementText(findTestObject('PolicyCenter/PolicyCenterObjects/PC_ActivityDetail_Label_Subject'), 'Review and approve policy change')
